...
<div class="{{ $grid_size }}">
    <a href="{{ the_permalink() }}" class="box box-index box-card-post">
        <div class="box-container" data-equal-item>
            @if (regionhalland_get_thumbnail_source(null,array(400,225)))
            <div class="box-image ratio-16-9" style="background-image:url('{{ regionhalland_get_thumbnail_source(null,array(400,225)) }}');">
