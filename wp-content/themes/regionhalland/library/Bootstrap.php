...
/**
 * Composer autoloader from regionhalland
 */
...
if (file_exists(REGIONHALLAND_PATH . 'vendor/acf/acf.php') && !is_plugin_active('advanced-custom-fields-pro/acf.php')) {
    new \RegionHalland\Acf();

    if (!class_exists('acf')) {
        require_once REGIONHALLAND_PATH . 'vendor/acf/acf.php';
    }
}
...
add_action('init', function () {
    ...
    $acfExportManager->setTextdomain('regionhalland');
    $acfExportManager->setExportFolder(REGIONHALLAND_PATH . 'library/AcfFields');
