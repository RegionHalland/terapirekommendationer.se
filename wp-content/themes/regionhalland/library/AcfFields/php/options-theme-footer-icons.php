    ...
    'fields' => array(
        0 => array(
            'sub_fields' => array(
                ...
                2 => array(
                    'default_value' => '',
                    'placeholder' => __(__('Enter a    url with the format http://example.com', 'regionhalland'), 'regionhalland'),
                    'key' => 'field_56af23370093d',
                    'label' => __('Url', 'regionhalland'),
                    'name' => 'link_url',
                    'type' => 'url',
                    'instructions' => '',
                    'required' => 1,
            ...
            'max' => 0,
            'layout' => 'table',
            'button_label' => __('Add icon', 'regionhalland'),
            'collapsed' => '',
            'key' => 'field_56af229cf0bb5',
            'label' => __('Footer icons repeater', 'regionhalland'),
            'name' => 'footer_icons_repeater',
            'type' => 'repeater',
            'instructions' => __('Add icons to the footer of your site. Link to external resources link facebook, twitter and linkedin! <style>.acf-field-font-awesome .fa-live-preview {display:none;}</style>', 'regionhalland'),
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
