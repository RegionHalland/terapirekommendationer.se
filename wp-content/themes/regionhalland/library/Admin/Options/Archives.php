    ...
    public function addArchiveOptions()
    {
        ...
        foreach ($postTypes as $posttype => $args) {
            ...
            $fieldArgs = array(
                ...
                'title' => __('Archive for', 'regionhalland') . ': ' . $args->label,
                'fields' => array(),
                'location' => array (
                    array (
                        array (
            ...
            if ($args->has_archive || $args->name === 'post') {
                ...
                $fieldArgs['fields'][] = array (
                    ...
                    'wrapper' => array (
                        'width' => '',
                        'class' => 'regionhalland-theme-options-label',
                        'id' => '',
                    ),
                    'message' => '',
                    'new_lines' => 'wpautop',
                ...
                $fieldArgs['fields'][] = array(
                    ...
                    "type" => "text",
                    "instructions" => __('Leave empty to hide title', 'regionhalland'),
                    "required" => 0,
                    "conditional_logic" => 0,
                    "wrapper" => array(
                        "width" => "",
                ...
                $metaKeysRaw = \RegionHalland\Helper\Post::getPosttypeMetaKeys($posttype);
