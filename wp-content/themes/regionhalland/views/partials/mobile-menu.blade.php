<form class="search" method="get" action="/">
    ...
    <div class="input-group">
        <input id="searchkeyword-mobile" autocomplete="off" class="form-control" type="search" name="s" placeholder="<?php echo get_field('search_placeholder_text', 'option') ? get_field('search_placeholder_text', 'option') : __('What are you looking for?', 'regionhalland'); ?>" value="<?php echo (!empty(get_search_query())) ? get_search_query() : ''; ?>">
