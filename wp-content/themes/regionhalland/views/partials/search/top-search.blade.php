...
?>
<form class="search top-search hidden-xs hidden-sm" method="get" action="{{ apply_filters('RegionHalland/search_form/action', home_url()) }}">
    ...
    <div class="input-group">
        ...
        <span class="input-group-addon-btn">
            <input type="submit" class="btn btn-primary" value="{{ get_field('search_button_text', 'option') ? get_field('search_button_text', 'option') : __('Search', 'regionhalland') }}">
        </span>
    </div>
</form>
