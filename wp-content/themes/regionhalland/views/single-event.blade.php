...
<div class="container main-container">
    ...
    <div class="grid event-single">
        <div class="grid-md-7">
            @if (regionhalland_get_thumbnail_source(null, array(750,750)))
                <img src="{{ regionhalland_get_thumbnail_source(null, array(750,750)) }}" alt="{{ the_title() }}" class="image gutter gutter-bottom">
            @endif
        </div>
        <div class="grid-md-1">
        </div>
