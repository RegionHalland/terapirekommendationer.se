...
if (function_exists('acf_add_local_field_group')) {
    ...
    'fields' => array(
        0 => array(
            'default_value' => 0,
            'message' => __('Yes, disable posts.', 'regionhalland'),
            'ui' => 0,
            'ui_on_text' => '',
            'ui_off_text' => '',
            'key' => 'field_56c6baa16b6ed',
            'label' => __('Disable blog', 'regionhalland'),
        ...
        1 => array(
            'default_value' => 0,
            'message' => __('Yes, disable pages.', 'regionhalland'),
            'ui' => 0,
            'ui_on_text' => '',
            'ui_off_text' => '',
            'key' => 'field_56c6bf6a28bb4',
            'label' => __('Disable pages', 'regionhalland'),
