...
class NavigationTree
{
    ...
    protected function startItem($item, $attributes = array(), $hasChildren = false)
    {
        ...
        if ($outputSubmenuToggle) {
            $this->addOutput('<button class="vertical-nav__toggle" data-load-submenu="' . $objId . '"><span class="sr-only">' . __('Show submenu', 'municipio') . '</span><svg class="icon--sm"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#caret-bottom"></use></svg></button>');
        }
    }
