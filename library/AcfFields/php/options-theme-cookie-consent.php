...
if (function_exists('acf_add_local_field_group')) {
    ...
    'fields' => array(
        0 => array(
            'default_value' => 1,
            'message' => __('Show cookie consent to users if not already accepted', 'regionhalland'),
            'ui' => 0,
            'ui_on_text' => '',
            'ui_off_text' => '',
            'key' => 'field_56bc6b7837da1',
            'label' => __('Active', 'regionhalland'),
        ...
        1 => array(
            ...
            'label' => __('Message', 'regionhalland'),
        ...
        3 => array(
            'layout' => 'vertical',
            'choices' => array(
                'top' => __('At the top of the page', 'regionhalland'),
                'bottom-fixed' => __('Fixed to bottom of window', 'regionhalland'),
            ),
            'default_value' => '',
            'other_choice' => 0,
            'save_other_choice' => 0,
            ...
            'label' => __('Placement', 'regionhalland'),
